...
/**
	...
	private static void setupFBO(final Framebuffer fbo) {
		...
		// Width, Height
		EXTFramebufferObject.glRenderbufferStorageEXT(EXTFramebufferObject.GL_RENDERBUFFER_EXT, EXTPackedDepthStencil.GL_DEPTH_STENCIL_EXT, MinecraftClient.getInstance().getWindow().getFramebufferHeight(), MinecraftClient.getInstance().getWindow().getFramebufferWidth());
