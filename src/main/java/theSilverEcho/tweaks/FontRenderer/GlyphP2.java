...
public class GlyphP2
{
	...
	public GlyphP2(Font font, boolean antiAliasing, boolean fractionalMetrics)
	{
		this.font = font;
	...
	public void loadBind(BufferedImage image)
	{
		...
		ByteBuffer buffer = BufferUtils.createByteBuffer(image.getWidth() * image.getHeight() * 16);
	...
	public void setupTexture()
	{
		...
		//		MinecraftClient.getInstance().getTextureManager().registerDynamicTexture("a", bufferedImage)
		...
		NativeImage image = new NativeImage(bufferedImage.getWidth(), bufferedImage.getHeight(), false);
//		image.loadFromTextureImage(0,true);//fillRect(0,0,100,100,-1);
		loadedTexture = new NativeImageBackedTexture(image);
		//		loadedTexture.setImage(bufferedImage);
